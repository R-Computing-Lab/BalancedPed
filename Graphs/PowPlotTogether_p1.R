...
df_p1 <- rbind(df_p1c2, df_p1c5, df_p1c8, df_p1c11)
df_p1$Combination <- as.factor(df_p1$Combination)


g1 <-ggplot(data = df_p1)+ geom_line(mapping = aes(x = Nped, y = power, color= Combination), size = 1.5) +
...
ggsave( "~/R-Project/BalancedPed/Simulations/p1/graph1.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
