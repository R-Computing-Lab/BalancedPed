...
lamdaUnit_p8c3 <- meanDiffLL_mtam_p8c3/env_p8c3$smr1$numObs
SSize_p8c3 <- 1: num_ped
...
lamdaUnit_p8c7 <- meanDiffLL_mtam_p8c7/env_p8c7$smr1$numObs
SSize_p8c7 <- 1: num_ped
...
ggsave( "~/R-Project/BalancedPed/Simulations/p8/graph2.png",g1, width = 10, height = 4.5,  type = "cairo-png", dpi = 900)
