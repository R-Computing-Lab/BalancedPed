...
#load("~/BalancedPed/Simulations/p10/p10c6/modelSmr.Rdata", envir = env_p10c6)


meanDiffLL_mtam_p10c6 <- env_p10c6$smr2$Minus2LogLikelihood - env_p10c6$smr1$Minus2LogLikelihood
PN <- ncol(env_p10c6[["smr1"]][["dataSummary"]][["fam1"]])*length(env_p10c6[["smr1"]][["dataSummary"]])
lamdaUnit_p10c6 <- meanDiffLL_mtam_p10c6/PN
SSize_p10c6 <- 1: N_indi
...
df_c6 <- rbind(df_p2c6, df_p5c6, df_p8c6, df_p10c6)
...
ggsave( "~/R-Project/BalancedPed/Graphs/Appendix/c6all.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
