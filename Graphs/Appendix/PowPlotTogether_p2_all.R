...
lamdaUnit_p2c3 <- (meanDiffLL_mtam_p2c3 * 1)/env_p2c3$smr1$numObs
SSize_p2c3 <- 0: num_ped
...
lamdaUnit_p2c5 <- meanDiffLL_mtam_p2c5* .965/env_p2c5$smr1$numObs
SSize_p2c5 <- 0: num_ped
...
lamdaUnit_p2c7 <- meanDiffLL_mtam_p2c7* .95/env_p2c7$smr1$numObs
SSize_p2c7 <- 0: num_ped
...
lamdaUnit_p2c8 <- meanDiffLL_mtam_p2c8* .95/env_p2c8$smr1$numObs
SSize_p2c8 <- 0: num_ped
...
ggsave( "~/R-Project/BalancedPed/Graphs/Appendix/p2all.png",g1, width = 10, height = 4.5,  type = "cairo-png", dpi = 900)
