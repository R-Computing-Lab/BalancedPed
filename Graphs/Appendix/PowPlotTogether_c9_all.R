...
#load("~/BalancedPed/Simulations/p10/p10c9/modelSmr.Rdata", envir = env_p10c9)


meanDiffLL_mtam_p10c9 <- env_p10c9$smr2$Minus2LogLikelihood - env_p10c9$smr1$Minus2LogLikelihood
PN <- ncol(env_p10c9[["smr1"]][["dataSummary"]][["fam1"]])*length(env_p10c9[["smr1"]][["dataSummary"]])
lamdaUnit_p10c9 <- meanDiffLL_mtam_p10c9/PN
SSize_p10c9 <- 1: N_indi
...
df_c9 <- rbind(df_p2c9, df_p5c9, df_p8c9, df_p10c9)
...
ggsave( "~/R-Project/BalancedPed/Graphs/Appendix/c9all.png",g1, width = 6, height = 4.5,  type = "cairo-png", dpi = 900)
