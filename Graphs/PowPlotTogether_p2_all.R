...
lamdaUnit_p2c1 <- (meanDiffLL_mtam_p2c1/env_p2c1$smr1$numObs) * .95 
...
g1 <-ggplot(data = df_p2)+ geom_line(mapping = aes(x = Nped, y = power, color= Combination), size = 1, alpha = .8) +
      ...
      theme(plot.margin = margin(5,180,5,5,"pt"),
...
ggsave( "~/R-Project/BalancedPed/Simulations/p2/graph2.png",g1, width = 7.5, height = 4,  type = "cairo-png", dpi = 900)
